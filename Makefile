...
cweb_obj_config:
	$(CC) -O2 -g -c $(COMMON_INCS) -o $(CWEB_BUILD_DIR_OBJ)/$(CWEB_OBJ_CONFIG) $(CWEB_SRC_DIR)/$(CWEB_OBJ_CONFIG_SRC)
cweb_obj_logger:
	$(CC) -O2 -g -c $(COMMON_INCS) -o $(CWEB_BUILD_DIR_OBJ)/$(CWEB_OBJ_LOGGER) $(CWEB_SRC_DIR)/$(CWEB_OBJ_LOGGER_SRC)
cweb_obj_server:
	$(CC) -O2 -g -c $(COMMON_INCS) -o $(CWEB_BUILD_DIR_OBJ)/$(CWEB_OBJ_SERVER) $(CWEB_SRC_DIR)/$(CWEB_OBJ_SERVER_SRC)
cweb_obj_server_raw:
...
stress_obj_cli:
	$(CC) -O2 -g -c $(COMMON_INCS) -o $(STRESS_BUILD_DIR_OBJ)/$(STRESS_OBJ_CLI) $(STRESS_SRC_DIR)/$(STRESS_OBJ_CLI_SRC)
stress_prog: setup stress_objs
	$(CC) -O2 -g $(COMMON_INCS) $(STRESS_OBJS) -o $(STRESS_BUILD_DIR)/$(STRESS_PROG_OUT) $(STRESS_SRC_DIR)/$(STRESS_PROG_SRC)
json-c:
